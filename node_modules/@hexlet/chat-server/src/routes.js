...
const buildState = (defaultState) => {
  ...
  const state = {
    ...
    messages: [
    {body: '123', channelId: 1, username: 'admin', id: 3},
    {body: '123', channelId: 1, username: 'admin', id: 4},
    {body: '123', channelId: 2, username: 'admin', id: 5},
    {body: '123', channelId: 2, username: 'admin', id: 6},
  ],
